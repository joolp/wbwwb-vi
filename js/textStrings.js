...
var textStrings_VI = {
	...
	"warning": "cảnh báo: chương trình tiếp theo sẽ chứa\nnhững cảnh hợm hĩnh, lỗ mãng\nvà giết người hàng loạt.\nkhán giả cần cân nhắc trước khi xem",

	// (cam-instructions.png) Camera Instructions
	"pointAndClick": "TRỎ VÀ NHẤP",

	// (chyron3.png)
	"chyronNothing": "ÔI TRỜI, *KHÔNG* CÓ GÌ HẾT",
	...
	// (end_prototype.png)
	"endOfPrototype": "KẾT THÚC BẢN THỬ NGHIỆM",
...
const textStrings = textStrings_VI;
